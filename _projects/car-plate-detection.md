...
Built a real-time video processing pipeline using OpenCV and FFmpeg for plate annotation and output conversion.

Developed a Streamlit web app for image and video-based detection with adjustable confidence thresholds.